...
export const TrustClientData = {
  image: trustClient01,
  title: "نحن موثوقون من قبل أكثر من 200 عميل.",
  text:
    "نحن نفتخر بموثوقية خدماتنا وبالثقة التي يولوها لنا عملاؤنا، حيث أننا قد حققنا ثقتهم من خلال تقديم خدمات عالية الجودة والتي تلبي احتياجاتهم بكل دقة واحترافية. ومن خلال خبرتنا الواسعة والتي تمتد لعدة سنوات، وفريق العمل المؤهل والمتخصص في مجالات عدة، تمكنا من تقديم خدمات مميزة وفعالة لأكثر من 200 عميل، مما يدل على جودة عملنا واحترافيته. ونحن نعد عملائنا بالاستمرار في تقديم الخدمات المميزة والموثوقة التي تلبي احتياجاتهم المتغيرة، ونسعى دوماً لتحقيق رضاهم وإرضاءهم بكل ما نقدمه.",
  url: "/about"
};
